...
## Лабораторная работа №1 <a name="laboratory-work-1"> 

### Описание <a name="description-lab-1"> 
...
### Варианты <a name="variants-lab-1">
...
## Лабораторная работа №2 <a name="laboratory-work-2"> 

### Описание <a name="description-lab-2"> 
Написать два скрипта на языке shell, которые выводят списки:

### Варианты <a name="variants-lab-2">
...
### Дополнительные условия <a name="additional-conditions-lab-2">
...
## Лабораторная работа №3 <a name="laboratory-work-3"> 

### Описание <a name="description-lab-3"> 
Написать программу на языке shell, выдающую:

### Варианты <a name="variants-lab-3">
...
### Дополнительные условия <a name="additional-conditions-lab-3">
